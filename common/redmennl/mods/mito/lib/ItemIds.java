...
public class ItemIds
{
	...
	public static int MINERSDIAMONDHELMET_DEFAULT= 4503;
	public static int MINERSIRONHELMETON_DEFAULT= 4504;
	...
	public static int MINERSGOLDHELMET;
	public static int MINERSDIAMONDHELMET;
	public static int MINERSIRONHELMETON;
