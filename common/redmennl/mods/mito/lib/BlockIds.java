...
public class BlockIds
{
    ...
    // Default block ids
    public static int PORTABLEHOUSE_DEFAULT = 1530;
    public static int LIGHTEMITTER_DEFAULT = 1531;
    ...
    public static int POWERCONNECTOR_DEFAULT = 1536;

    // Used block ids
    public static int PORTABLEHOUSE;
    public static int LIGHTEMITTER;
