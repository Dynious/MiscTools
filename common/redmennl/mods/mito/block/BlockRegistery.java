...
public class BlockRegistery
{
    ...
    public static void register()
    {
        ...
        GameRegistry.registerBlock(lightEmitter, Library.MOD_ID
                + lightEmitter.getUnlocalizedName().substring(5));
        GameRegistry.registerBlock(letter, ItemLetter.class, Library.MOD_ID
                + letter.getUnlocalizedName().substring(5));
        GameRegistry.registerBlock(letter2, ItemLetter2.class, Library.MOD_ID
        ...
        LanguageRegistry.addName(new ItemStack(portableHouse, 1, 2),
                "Advanced Portable House");
        LanguageRegistry.addName(new ItemStack(portableHouse, 1, 3),
                "Advanced Portable House Deployer");
    ...
    {
        GameRegistry.addRecipe(new ItemStack(portableHouse, 1, 0), "ipi",
                "pep", "ipi", 'i', Item.ingotIron, 'p', Block.thinGlass, 'e',
                Item.enderPearl);
        GameRegistry.addRecipe(new ItemStack(portableHouse, 1, 2), "ded",
                "ehe", "ded", 'd', Item.diamond, 'e', Item.enderPearl, 'h',
                new ItemStack(portableHouse, 1, 0));
        GameRegistry.addRecipe(new ItemStack(letterConstructor), "sps", "scs",
                "sss", 's', Block.stone, 'p', Item.pickaxeIron, 'c',
                Block.workbench);
    }
