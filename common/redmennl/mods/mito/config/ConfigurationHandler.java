	...
	public static void init(File configFile) {
		...
		configuration = new Configuration(configFile);
		 ...
		 try {
	            ...
	            BlockIds.PORTABLEHOUSE = configuration.getBlock("portableHouse", BlockIds.PORTABLEHOUSE_DEFAULT).getInt(BlockIds.PORTABLEHOUSE_DEFAULT);
	            BlockIds.LIGHTEMITTER = configuration.getBlock("lightEmitter", BlockIds.LIGHTEMITTER_DEFAULT).getInt(BlockIds.LIGHTEMITTER_DEFAULT);
	            ...
	            ItemIds.MINERSGOLDHELMET = configuration.getItem("minersGoldHelmet", ItemIds.MINERSGOLDHELMET_DEFAULT).getInt(ItemIds.MINERSGOLDHELMET_DEFAULT);
	            ItemIds.MINERSDIAMONDHELMET = configuration.getItem("minersDiamondHelmet", ItemIds.MINERSDIAMONDHELMET_DEFAULT).getInt(ItemIds.MINERSDIAMONDHELMET_DEFAULT);
