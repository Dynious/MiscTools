...
public class GuiPortableHouse extends GuiScreen
{
    ...
    public GuiPortableHouse(EntityPlayer player, World world,
            TilePortableHouse tile, TilePortableHouseDeployer tile2)
    {
        this.tile = tile;
        this.tile2 = tile2;
    }
    ...
    public void initGui()
    {
        ...
        buttonList.add(new GuiButton(9, width / 2 + 78, height / 2 - 83, 10,
                10, "X"));
        ...
        if (tile2 != null)
        {
            buttonList.add(new GuiButton(7, width / 2 - 40, height / 2 - 70,
                    80, 20, "Deploy"));
            buttonList.add(clearArea = new GuiButton(8, width / 2 - 40,
                    height / 2 - 30, 80, 20, "Clear Off"));
            clearArea.displayString = tile2.clearArea ? "Clear On"
                    : "Clear Off";
        }
        super.initGui();
    }
    ...
    public void drawScreen(int i, int j, float f)
    {
        try
        {
            ...
            if (tile != null)
            {
                ...
                fontRenderer.drawString(hightText,
                        width / 2 - fontRenderer.getStringWidth(hightText) / 2
                                - 33, height / 2 - 39, 0xFFFFFF);
                fontRenderer.drawString("Size",
                        width / 2 - fontRenderer.getStringWidth(hightText) / 2
                                - 70, height / 2 - 75, 0xFFFFFF);
                fontRenderer.drawString("Hight",
                        width / 2 - fontRenderer.getStringWidth(hightText) / 2
                                - 40, height / 2 - 75, 0xFFFFFF);
     ...
     * button = par3; if(par3 == 1) par3 = 0; super.mouseClicked(par1, par2,
     * par3); }
     */
