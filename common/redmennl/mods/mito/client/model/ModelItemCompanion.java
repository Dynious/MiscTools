...
public class ModelItemCompanion
{
    ...
    public void render(ItemStack item)
    {
    	...
    	FMLClientHandler.instance().getClient().renderEngine.func_110577_a(i.textureBody);
    	model.renderAllExcept("rightArm", "leftArm", "wheel", "rightLeg", "leftLeg");
    	
    	if (hasWheel)
    	{
	    	GL11.glPushMatrix();
	    	FMLClientHandler.instance().getClient().renderEngine.func_110577_a(i.textureWheel);
    	...
    	{
        	GL11.glPushMatrix();
        	FMLClientHandler.instance().getClient().renderEngine.func_110577_a(i.textureLegs);
    	...
    	GL11.glPushMatrix();
    	FMLClientHandler.instance().getClient().renderEngine.func_110577_a(i.textureArms);
