...
public class ModelCompanion extends ModelBase
{
            ...
            float par5, float par6, float par7)
    {
        ...
        if (e.hasLegs)
        {
            GL11.glPushMatrix();
            FMLClientHandler.instance().getClient().renderEngine
                    .func_110577_a(e.textureLegs);

            GL11.glTranslatef(0F, blockSizeOffset * e.legOffsetY, 0F);
            float LeftArmAngleX = MathHelper.cos(par2 * 0.6662F
                    + (float) Math.PI)
                    * 1.4F * par3;
            GL11.glRotatef(LeftArmAngleX * (180F / (float) Math.PI), 1.0F,
                    0.0F, 0.0F);
            GL11.glTranslatef(0F, blockSizeOffset * -e.legOffsetY, 0F);
            ...
            GL11.glRotatef(RightArmAngleX * (180F / (float) Math.PI), 1.0F,
                    0.0F, 0.0F);
            GL11.glTranslatef(0F, blockSizeOffset * -e.legOffsetY, 0F);
        ...
        GL11.glTranslatef(0F, blockSizeOffset * e.armOffsetY, 0F);
        float RightArmAngleX = MathHelper.cos(par2 * 0.6662F + (float) Math.PI)
                * 2.0F * par3;
        GL11.glRotatef(RightArmAngleX * (180F / (float) Math.PI), 1.0F, 0.0F,
                0.0F);
        GL11.glTranslatef(0F, blockSizeOffset * -e.armOffsetY, 0F);
