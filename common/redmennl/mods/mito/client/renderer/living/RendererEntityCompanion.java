...
public class RendererEntityCompanion extends RenderLiving
{
    ...
    public void renderCompanion(EntityCompanionDummy entity, double par2,
    ...
    public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
            double par4, double par6, float par8, float par9)
    {
        renderCompanion((EntityCompanionDummy) par1EntityLiving, par2, par4, par6,
                par8, par9);
    }
    ...
    {
        renderCompanion((EntityCompanionDummy) par1Entity, par2, par4, par6, par8,
                par9);
    }
